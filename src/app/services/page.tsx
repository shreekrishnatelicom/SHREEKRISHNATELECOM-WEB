...
export const metadata: Metadata = {
  title: "Printing, Photocopy & Government Services in Raipur | Rates & Options",
  description: "Check prices for document printing, Xerox, color prints, instant passport photos, lamination, spiral binding & online government form filling in Raipur at Shree Krishna Telecom.",
  keywords: [
...
export default async function ServicesPage() {
  ...
  const services = rawServices.map((s: any) => ({
    ...
    generateReceipt: s.generateReceipt ?? true,
    allowOnlinePayment: s.allowOnlinePayment ?? true,
    allowOfflinePayment: s.allowOfflinePayment ?? true,
  }));
