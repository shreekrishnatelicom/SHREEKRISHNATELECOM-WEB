  ...
  return (
    <div className="flex flex-col">
      ...
      <div className={`py-4 px-6 border-b-4 border-bauhaus-black font-black uppercase text-center text-sm tracking-wider flex items-center justify-center gap-2.5 ${
        settings.isOpen ? "bg-green-500 text-white" : "bg-bauhaus-red text-bauhaus-white"
      }`}>
        <span className="w-3 h-3 rounded-full bg-current animate-pulse"></span>
        We are currently {settings.isOpen ? "Open for Walk-ins & Online Orders" : "Closed (Accepting online uploads for tomorrow)"}
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { 
              icon: Clock, 
              title: "Hours", 
              lines: ["Mon – Sat: 9AM – 9PM", "Sunday: 10AM – 7PM", settings.isOpen ? "🟢 OPEN NOW" : "🔴 CLOSED NOW"] 
            },
            { 
              icon: Phone, 
              title: "Contact", 
